 ...
 */
final class Version20250308151728 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artwork ADD user_id INT DEFAULT NULL, DROP user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artwork ADD user VARCHAR(255) NOT NULL, DROP user_id');
    }
}
